...
(function (factory) {
    ...
    $.jstree.create = function (el, options) {
        // 2023-03-08 root 변경 추가
        if (options.root) {
            $.jstree.root = options.root;
        }
                ...
                if (s.url) {
                    ...
                    return $.ajax(s)
                        .done($.proxy(function (d, t, x) {
                            ...
                            // 2017.09.14 if 문 추가 : s
                            if ((type && type.indexOf('text') !== -1) || typeof d === "object") {
                                return this._append_json_data(obj, JSON.parse(d), function (status) { callback.call(this, status); });
                                //return callback.call(this, this._append_json_data(obj, d));
                            }
                            // 2017.09.14 if 문 추가 : e
