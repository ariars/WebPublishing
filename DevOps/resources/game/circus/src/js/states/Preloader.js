...
var WebFontConfig ={
	custom: {
        ...
        urls: ['../Resources/game/circus/src/css/fonts.css'],
	}
};
...
GameCtrl.Preloader.prototype = {
	...
	preload: function () {
        ...
        this.load.image('stage01', '../Resources/game/circus/src/assets/images/stage01.png');
        this.load.image('stage02', '../Resources/game/circus/src/assets/images/stage02.png');
		
		//  This is how you load an atlas
		//this.load.atlas('playButton', 'assets/images/play_button.png', 'assets/images/play_button.json');

        this.load.audio('stage1', ['../Resources/game/circus/src/assets/audio/stage1-4.mp3']);
        this.load.audio('stage2', ['../Resources/game/circus/src/assets/audio/stage1-4.mp3']);
        this.load.audio('failure', ['../Resources/game/circus/src/assets/audio/failure.mp3']);
...
var botData={'frames': [
    ...
    'sourceSize': {'w':17,'h':16}
        ...
        this.game.load.atlas('clown', '../Resources/game/circus/src/assets/images/CircusCharlieSheet1.gif', null, botData);
